...
public abstract class BaseLMTag extends GeoTag {
	...
	protected abstract void init (Resources res);

	public void baseAction(Context context, String title) {
		infoDialog (context, title, Html.fromHtml(context.getString(R.string.LugDialog, organizzazione, sito)));
	}
